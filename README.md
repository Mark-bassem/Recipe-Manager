...
- **🛡️ Route Protection** — Protected pages (Main, Favorites, Add Recipe, Recipe Details) require authentication.
...
1. Add recipes to `defaultRecipes` in `script.js`
...
<p align="center">
  <b>The Recipe Manager</b> — Your Kitchen Companion
</p>
